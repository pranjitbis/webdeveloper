...
<Nav />
        ...
        <div className={styles.container}>
          <div className={styles.visionMissionGrid} data-aos="fade-up">
            <div className={styles.visionCard}>
              ...
              <h3>Our Vision</h3>
              <p>
                To become a global leader in providing innovative, reliable, and
                cost-effective digital solutions that empower individuals,
            ...
            <div className={styles.missionCard}>
              ...
              <h3>Our Mission</h3>
              <p>
                To create opportunities, simplify challenges, and bridge the gap
                between businesses and digital transformation by offering
      ...
      <section className={styles.section}>
        <div className={styles.container}>
          <h2 className={styles.sectionTitleCenter} data-aos="fade-up">About the Founder</h2>
          <div className={styles.founderGrid}>
            <div className={styles.founderImageWrapper}>
              <div className={styles.founderPlaceholder } data-aos="fade-right">
                <svg
                  width="80"
                  height="80"
                  viewBox="0 0 24 24"
            ...
            <div className={styles.founderContent} data-aos="fade-left">
              ...
              <div className={styles.founderDescription}>
                ...
                <p>
                  ...
                  services—it's about building a platform where businesses find
                  solutions and freelancers find opportunities.
                </p>
                <p>
        ...
        <div className={styles.container}  data-aos="fade-right">
          ...
          <div className={styles.valuesGrid}>
            ...
            <div className={styles.valueItem}>
              ...
              <h3>Innovation</h3>
              <p>
                Continuously evolving our solutions to stay ahead in the rapidly
            ...
            <div className={styles.valueItem}>
              ...
              <h3>Excellence</h3>
              <p>
                Striving for the highest quality in every service we provide and
